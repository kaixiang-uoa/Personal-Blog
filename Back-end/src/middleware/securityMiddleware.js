...
); // 1000 requests default
const SENSITIVE_RATE_LIMIT_WINDOW_MS = parseInt(
  process.env.SENSITIVE_RATE_LIMIT_WINDOW_MS || "3600000"
); // 1 hour default
const SENSITIVE_RATE_LIMIT_MAX_REQUESTS = parseInt(
  process.env.SENSITIVE_RATE_LIMIT_MAX_REQUESTS || "50"
); // 50 attempts default
const CONTACT_RATE_LIMIT_WINDOW_MS = parseInt(
  process.env.CONTACT_RATE_LIMIT_WINDOW_MS || "3600000"
); // 1 hour default
const CONTACT_RATE_LIMIT_MAX_REQUESTS = parseInt(
  process.env.CONTACT_RATE_LIMIT_MAX_REQUESTS || "20"
); // 20 attempts default
