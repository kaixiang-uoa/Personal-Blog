    ...
    if (Array.isArray(obj)) {
      ...
      return obj.some(item => {
        ...
        if (typeof item === 'object' && item !== null) {
          ...
          if (item.hasOwnProperty('degree') || item.hasOwnProperty('position') || item.hasOwnProperty('name')) {
            const requiredFields = item.hasOwnProperty('degree') ? ['degree', 'institution'] : 
                                 item.hasOwnProperty('position') ? ['position', 'company'] : 
                                 ['name'];
