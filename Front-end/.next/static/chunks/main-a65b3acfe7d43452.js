  ...
  [792],
  {
        ...
        getMiddleware() {
          return (
            (window.__MIDDLEWARE_MATCHERS = [
              {
                regexp:
                  '^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|trpc|_next|_vercel|.*\\..*).*))(\\.json)?[\\/#\\?]?$',
    ...
    8276: (e, t, r) => {
      ...
      function F(e, t) {
        ...
        return '/404' === r || '/_error' === r
          ...
          : (t.includes(r) ||
              t.some(t => {
                if ((0, p.isDynamicRoute)(t) && (0, m.getRouteRegex)(t).re.test(r))
                  return (e = t), !0;
              }),
        ...
        let {
          ...
          d = e => {
            ...
            return (function e(t, r, n) {
              ...
              .then(
                e => (
                  (u && 'no-cache' !== e.response.headers.get('x-middleware-cache')) || delete r[f],
                  e
                )
              )
              .catch(e => {
      ...
      class z {
        ...
        async change(e, t, r, n, o) {
          ...
          this._inFlightRoute &&
            this.clc &&
            (V || z.events.emit('routeChangeError', L(), this._inFlightRoute, Q),
            this.clc(),
            (this.clc = null)),
            (r = (0, v.addBasePath)(
              (0, E.addLocale)(
          ...
          if (!B && this.onlyAHashChange(J) && !Z) {
            ...
            try {
              ...
              throw (
                ((0, u.default)(e) && e.cancelled && z.events.emit('routeChangeError', e, J, Q), e)
              );
            }
          ...
          try {
            ...
            if (
              (B ||
                n.shallow ||
                (await this._bfl(r, 'resolvedAs' in a ? a.resolvedAs : void 0, W.locale)),
              'route' in a && el)
            ) {
              ...
              if (
                ...
                let e =
                  !Q.shallow && a.resolvedAs
                    ? a.resolvedAs
                    : (0, v.addBasePath)(
                        (0, E.addLocale)(new URL(r, location.href).pathname, W.locale),
                        !0
                      );
            ...
            if (B && es) {
              ...
              '/_error' === this.pathname &&
                (null == (w = self.__NEXT_DATA__.props) || null == (T = w.pageProps)
                  ? void 0
                  : T.statusCode) === 500 &&
              ...
              try {
                ...
                throw (
                  ((0, u.default)(e) && e.cancelled && z.events.emit('routeChangeError', e, J, Q),
                  e)
                );
              }
              return !0;
    ...
    9525: (e, t, r) => {
      ...
      let J = {
        ...
        et = !0;
      function er() {
        [J.beforeRender, J.afterHydrate, J.afterRender, J.routeChange].forEach(e =>
      ...
      function ei(e) {
        ...
        let P = ((t = et ? en : eo), (0, g.jsx)(ea, { callbacks: [t, _], children: m }));
        return (
          ee
            ? (0, b.default.startTransition)(() => {
                ee.render(P);
              })
            : ((ee = E.default.hydrateRoot(y, P, { onRecoverableError: B.onRecoverableError })),
              (et = !1)),
          h
        );
      }
