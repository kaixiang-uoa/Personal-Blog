...
const aboutSettings = [
  {
    key: 'about.intro',
    value: '<p>Hello! I\'m a passionate developer with a love for technology and innovation. I enjoy creating solutions that make a difference and sharing my knowledge with others.</p>',
    group: 'about',
    description: 'About page introduction'
  },
  {
    key: 'about.intro_zh',
    value: '<p>你好！我是一名热爱技术和创新的开发者。我喜欢创造能够产生影响的解决方案，并与他人分享我的知识。</p>',
    group: 'about',
