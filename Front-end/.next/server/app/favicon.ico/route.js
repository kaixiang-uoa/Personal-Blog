    ...
    (A.modules = {
      ...
      4525: (A, e, w) => {
        ...
        Object.defineProperty(e, '__esModule', { value: !0 }),
          !(function (A, e) {
            for (var w in e) Object.defineProperty(A, w, { enumerable: !0, get: e[w] });
          })(e, {
            ...
            unstable_rootParams: function () {
              return a.unstable_rootParams;
            },
            userAgent: function () {
              return o.userAgent;
            },
            userAgentFromString: function () {
              return o.userAgentFromString;
            },
          });
        let i = w(42174),
          r = w(76268),
      ...
      12944: (A, e, w) => {
        ...
        function P() {
          let A = i.workAsyncStorage.getStore(),
            e = r.workUnitAsyncStorage.getStore();
          if (A) {
            if (e && 'after' === e.phase && !(0, D.isRequestAPICallableInsideAfter)())
            ...
            if (e)
              if ('prerender' === e.type)
                return (0, n.makeHangingPromise)(e.renderSignal, '`connection()`');
              else
                'prerender-ppr' === e.type
                  ? (0, t.postponeWithTracking)(A.route, 'connection', e.dynamicTracking)
                  : 'prerender-legacy' === e.type &&
                    (0, t.throwToInterruptStaticGeneration)('connection', A, e);
            (0, t.trackDynamicDataInDynamicRender)(A, e);
          }
      ...
      53182: (A, e, w) => {
        ...
        function t(A) {
          return { ...(0, i.default)(A), isBot: void 0 !== A && r(A) };
        }
        function o({ headers: A }) {
          return t(A.get('user-agent') || void 0);
        }
      },
      61127: (A, e, w) => {
        'use strict';
        ...
        let a = 'force-static',
          s = new r.AppRouteRouteModule({
            ...
            resolvedPagePath:
              'next-metadata-route-loader?filePath=%2FUsers%2Fkxz%2FDesktop%2FWeb-practice%2FPersonal-Blog%2FFront-end%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__',
            nextConfigOutput: '',
            userland: i,
          }),
          { workAsyncStorage: u, workUnitAsyncStorage: c, serverHooks: l } = s;
        function b() {
          return (0, o.patchFetch)({ workAsyncStorage: u, workUnitAsyncStorage: c });
        }
      },
      63033: A => {
        'use strict';
        ...
        (() => {
                ...
                !(function (o, n) {
                  ...
                  var D = 'function',
                    ...
                    F = function (A, e) {
                      var w = {};
                      for (var i in A)
                        e[i] && e[i].length % 2 == 0 ? (w[i] = e[i].concat(A[i])) : (w[i] = A[i]);
                      return w;
                    },
                    J = function (A) {
                      for (var e = {}, w = 0; w < A.length; w++) e[A[w].toUpperCase()] = A[w];
                      return e;
                    },
                    U = function (A, e) {
                    ...
                    K = function (A, e) {
                      if (typeof A === s)
                        return (
                          (A = A.replace(/^\s\s*/, '')), typeof e === P ? A : A.substring(0, 350)
                        );
                    },
                    W = function (A, e) {
                      for (var w, i, r, t, o, P, s = 0; s < e.length && !o; ) {
                        var u = e[s],
                          c = e[s + 1];
                        for (w = i = 0; w < u.length && !o && u[w]; )
                          if ((o = u[w++].exec(A)))
                            for (r = 0; r < c.length; r++)
                              (P = o[++i]),
                                typeof (t = c[r]) === a && t.length > 0
                                  ? 2 === t.length
                                    ? typeof t[1] == D
                                      ? (this[t[0]] = t[1].call(this, P))
                                      : (this[t[0]] = t[1])
                                    : 3 === t.length
                                      ? typeof t[1] !== D || (t[1].exec && t[1].test)
                                        ? (this[t[0]] = P ? P.replace(t[1], t[2]) : void 0)
                                        : (this[t[0]] = P ? t[1].call(this, P, t[2]) : void 0)
                                      : 4 === t.length &&
                                        (this[t[0]] = P
                                          ? t[3].call(this, P.replace(t[1], t[2]))
                                          : n)
                                  : (this[t] = P || n);
                        s += 2;
                      }
                    ...
                    Z = function (A, e) {
                      for (var w in e)
                        if (typeof e[w] === a && e[w].length > 0) {
                          for (var i = 0; i < e[w].length; i++)
                            if (U(e[w][i], A)) return '?' === w ? n : w;
                        } else if (U(e[w], A)) return '?' === w ? n : w;
                      return A;
                    },
                    _ = {
                      ME: '4.90',
                    ...
                    AA = function (A, e) {
                      if ((typeof A === a && ((e = A), (A = n)), !(this instanceof AA)))
                        return new AA(A, e).getResult();
                      var w = typeof o !== P && o.navigator ? o.navigator : n,
                        i = A || (w && w.userAgent ? w.userAgent : ''),
                        r = w && w.userAgentData ? w.userAgentData : n,
                        t = e ? F($, e) : $,
                        p = w && w.userAgent == i;
                      return (
                        (this.getBrowser = function () {
                          ...
                          return (
                            (e[l] = n),
                            (e[d] = n),
                            W.call(e, i, t.browser),
                            (e[u] =
                              typeof (A = e[d]) === s
                                ? A.replace(/[^\d\.]/g, '').split('.')[0]
                                : n),
                            p && w && w.brave && typeof w.brave.isBrave == D && (e[l] = 'Brave'),
                            e
                          );
                        }),
                        (this.getCPU = function () {
                          var A = {};
                          return (A[f] = n), W.call(A, i, t.cpu), A;
                        }),
                        (this.getDevice = function () {
                          ...
                          return (
                            ...
                            (A[b] = n),
                            W.call(A, i, t.device),
                            p && !A[b] && r && r.mobile && (A[b] = m),
                            p &&
                              'Macintosh' == A[c] &&
                              w &&
                              typeof w.standalone !== P &&
                              w.maxTouchPoints &&
                              w.maxTouchPoints > 2 &&
                              ((A[c] = 'iPad'), (A[b] = h)),
                            A
                        ...
                        (this.getEngine = function () {
                          var A = {};
                          return (A[l] = n), (A[d] = n), W.call(A, i, t.engine), A;
                        }),
                        (this.getOS = function () {
                          var A = {};
                          return (
                            ...
                            p &&
                              ...
                              r &&
                              'Unknown' != r.platform &&
                              (A[l] = r.platform.replace(/chrome os/i, X).replace(/macos/i, q)),
                            A
                          );
                        }),
                        ...
                        (this.setUA = function (A) {
                          return (i = typeof A === s && A.length > 350 ? K(A, 350) : A), this;
                        }),
                        this.setUA(i),
                        this
                      );
                  ...
                  (AA.VERSION = '1.0.35'),
                    (AA.BROWSER = J([l, d, u])),
                    (AA.CPU = J([f])),
                    (AA.DEVICE = J([c, g, b, p, m, B, h, v, y])),
                    (AA.ENGINE = AA.OS = J([l, d])),
                    typeof t !== P
                      ? (r.exports && (t = r.exports = AA), (t.UAParser = AA))
                      : w.amdO
                        ? void 0 ===
                            (i = function () {
                              return AA;
                            }.call(e, w, e, A)) || (A.exports = i)
                        : typeof o !== P && (o.UAParser = AA);
                  var Ae = typeof o !== P && (o.jQuery || o.Zepto);
                  if (Ae && !Ae.ua) {
                    var Aw = new AA();
                    (Ae.ua = Aw.getResult()),
                      (Ae.ua.get = function () {
          ...
          function o(A) {
            ...
            var w = (t[A] = { exports: {} }),
              i = !0;
            try {
              r[A].call(w.exports, w, w.exports, o), (i = !1);
            } finally {
              i && delete t[A];
            }
            return w.exports;
          }
          (o.ab = __dirname + '/'), (A.exports = o(226));
        })();
      },
      72079: (A, e, w) => {
        'use strict';
        ...
        async function a() {
          ...
          if (!A)
            throw Object.defineProperty(
              new i.InvariantError('Missing workStore in unstable_rootParams'),
              '__NEXT_ERROR_CODE',
                ...
                if (i) {
                  ...
                  if (u) {
                    if ('prerender' === w.type) {
                      let e = P.get(A);
                      if (e) return e;
                      let i = (0, n.makeHangingPromise)(w.renderSignal, '`unstable_rootParams`');
                      return P.set(A, i), i;
                    }
                    var t = A,
                      o = i,
                    ...
                    return (
                      ...
                      Object.keys(t).forEach(A => {
                        D.wellKnownProperties.has(A) ||
                          (o.has(A)
                            ? Object.defineProperty(c, A, {
                                get() {
                                  let e = (0, D.describeStringPropertyAccess)(
                                    'unstable_rootParams',
                                    A
                                  );
                                  'prerender-ppr' === s.type
                                    ? (0, r.postponeWithTracking)(a.route, e, s.dynamicTracking)
                                    : (0, r.throwToInterruptStaticGeneration)(e, a, s);
                                },
                                enumerable: !0,
                              })
                            : (l[A] = t[A]));
      ...
      93426: (A, e, w) => {
        ...
        let i = w(23158),
          ...
          o = w(43763),
          n = w(23158),
          D = Symbol('internal response'),
          P = new Set([301, 302, 303, 307, 308]);
        function a(A, e) {
          var w;
          if (null == A || null == (w = A.request) ? void 0 : w.headers) {
            ...
            let w = [];
            for (let [i, r] of A.request.headers) e.set('x-middleware-request-' + i, r), w.push(i);
        ...
        class s extends Response {
          constructor(A, e = {}) {
            super(A, e);
            let w = this.headers,
              P = new Proxy(new n.ResponseCookies(w), {
                get(A, r, t) {
                  switch (r) {
                    case 'delete':
                    case 'set':
                      return (...t) => {
                        let o = Reflect.apply(A[r], A, t),
                          D = new Headers(w);
                        return (
                          o instanceof n.ResponseCookies &&
                            w.set(
                    ...
                    default:
                      return o.ReflectAdapter.get(A, r, t);
                  }
                },
              });
            this[D] = {
              ...
              url: e.url
                ? new r.NextURL(e.url, {
                    headers: (0, t.toNodeOutgoingHttpHeaders)(w),
          ...
          static json(A, e) {
            ...
            return new s(w.body, w);
          }
          static redirect(A, e) {
            let w = 'number' == typeof e ? e : ((null == e ? void 0 : e.status) ?? 307);
            if (!P.has(w))
              throw Object.defineProperty(
            ...
            let i = 'object' == typeof e ? e : {},
              r = new Headers(null == i ? void 0 : i.headers);
            return (
              r.set('Location', (0, t.validateURL)(A)), new s(null, { ...i, headers: r, status: w })
            );
          }
          static rewrite(A, e) {
            let w = new Headers(null == e ? void 0 : e.headers);
            return (
              w.set('x-middleware-rewrite', (0, t.validateURL)(A)),
              a(e, w),
              new s(null, { ...e, headers: w })
            );
          }
          static next(A) {
            let e = new Headers(null == A ? void 0 : A.headers);
            return e.set('x-middleware-next', '1'), a(A, e), new s(null, { ...A, headers: e });
          }
        }
      },
      96559: (A, e, w) => {
