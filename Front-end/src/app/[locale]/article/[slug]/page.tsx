    ...
    <main className="min-h-screen bg-background flex flex-col">
      ...
      <ErrorBoundary>
        <div className="max-w-6xl mx-auto w-full px-4 md:px-6 lg:px-8 py-4">
          {/* Breadcrumbs */}
          {article && (
            <Breadcrumbs items={generateArticleBreadcrumbs(article, locale)} className="mb-4" />
          )}
          ...
          {isLoading ? (
            ...
            <>
              {/* Article banner with optimized image */}
              <div className="py-4">
                <div className="relative min-h-[280px] md:min-h-[320px] rounded-xl overflow-hidden">
                  <OptimizedImage
                    src={article.featuredImage || articleBanner}
                    alt={generateAltText('article', article.title)}
                    width={1200}
                    height={400}
