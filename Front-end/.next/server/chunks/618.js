...
(exports.id = 618),
  ...
  (exports.modules = {
    ...
    8610: (e, t, r) => {
          ...
          (e.prototype.parseArgumentOptions = function (e, t, r, s) {
            ...
            switch (u) {
              ...
              case 'select':
                var H = this.clonePosition();
                if ((this.bumpSpace(), !this.bumpIf(',')))
                  return this.error(n.EXPECT_SELECT_ARGUMENT_OPTIONS, V(H, (0, c.Cl)({}, H)));
                this.bumpSpace();
            ...
            (function e(t) {
              t.forEach(function (t) {
                if ((delete t.location, _(t) || A(t)))
                  ...
                  (d(t) && S(t.style)) || ((H(t) || v(t)) && N(t.style))
      ...
      function eH(e, t) {
        return ed((...t) => new e(...t), t);
      }
      function ev(e) {
        return {
          getDateTimeFormat: eH(Intl.DateTimeFormat, e.dateTime),
          getNumberFormat: eH(Intl.NumberFormat, e.number),
          getPluralRules: eH(Intl.PluralRules, e.pluralRules),
          getRelativeTimeFormat: eH(Intl.RelativeTimeFormat, e.relativeTime),
          getListFormat: eH(Intl.ListFormat, e.list),
          getDisplayNames: eH(Intl.DisplayNames, e.displayNames),
        };
      }
      function e_(e, t, r, n) {
        let i = eg(n, r);
