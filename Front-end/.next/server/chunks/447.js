(exports.id = 447),
  ...
  (exports.modules = {
    ...
    11959: (e, t) => {
      ...
      function n(e, t) {
        ...
        return s < 0
          ? { pathname: e }
          : ((n = t[s]), { pathname: (e = e.slice(n.length + 1) || '/'), detectedLocale: n });
      }
    },
    14823: (e, t) => {
      'use strict';
    ...
    29169: (e, t) => {
      ...
      function r(e) {
        ...
        let a = new Response(r, { status: e.status, statusText: e.statusText, headers: e.headers });
      ...
      function _(e, { workAsyncStorage: t, workUnitAsyncStorage: r }) {
        let u = async (u, f) => {
          ...
          let v = (null == y ? void 0 : y.href) ?? '',
            b = (null == f || null == (_ = f.method) ? void 0 : _.toUpperCase()) || 'GET',
            E = (null == f || null == (m = f.next) ? void 0 : m.internal) === !0,
            S = '1' === process.env.NEXT_OTEL_FETCH_DISABLED,
            O = E ? void 0 : performance.timeOrigin + performance.now(),
            R = t.getStore(),
            P = r.getStore(),
          ...
          let N = (0, a.getTracer)().trace(
            ...
            async () => {
              var t;
              let r, n, a, _;
              if (E || !R || R.isDraftMode) return e(u, f);
              let m = u && 'object' == typeof u && 'string' == typeof u.method,
                y = e => (null == f ? void 0 : f[e]) || (m ? u[e] : null),
                b = e => {
                  var t, r, n;
              ...
              let C = null == P ? void 0 : P.implicitTags,
                x = P && 'unstable-cache' === P.type ? 'force-no-store' : R.fetchCache,
                w = !!R.isUnstableNoStore,
                D = y('cache'),
                I = '';
              'string' == typeof D &&
                void 0 !== S &&
                (('force-cache' === D && 0 === S) || ('no-store' === D && (S > 0 || !1 === S))) &&
                ((r = `Specified "cache: ${D}" and "revalidate: ${S}", only one should be specified.`),
                (D = void 0),
                (S = void 0));
              let M =
                  'no-cache' === D ||
                  ...
                  'force-no-store' === x ||
                  'only-no-store' === x,
                j = !x && !D && !S && R.forceDynamic;
              'force-cache' === D && void 0 === S
                ? (S = !1)
                : (null == P ? void 0 : P.type) !== 'cache' && (M || j) && (S = 0),
                ('no-cache' === D || 'no-store' === D) && (I = `cache: ${D}`),
                (_ = p(S, R.route));
              let L = y('headers'),
                k = 'function' == typeof (null == L ? void 0 : L.get) ? L : new Headers(L || {}),
                G = k.get('authorization') || k.get('cookie'),
                B = !['get', 'head'].includes(
                  (null == (t = y('method')) ? void 0 : t.toLowerCase()) || 'get'
                ),
                U = void 0 == x && (void 0 == D || 'default' === D) && void 0 == S,
                H = (U && !R.isPrerendering) || ((G || B) && A && 0 === A.revalidate);
                  ...
                  ? 'default-cache' !== x || w
                    ? 'default-no-store' === x
                      ...
                      : w
                        ...
                        : H
                          ? ((_ = 0), (I = 'auto no cache'))
                          : ((I = 'auto cache'), (_ = A ? A.revalidate : o.INFINITE_CACHE))
                    : ((_ = o.INFINITE_CACHE), (I = 'fetchCache = default-cache'))
                  : I || (I = `revalidate: ${_}`),
                !(R.forceStatic && 0 === _) && !H && A && _ < A.revalidate)
              ) {
                if (0 === _)
                  if (P && 'prerender' === P.type)
                    ...
                    (0, i.markCurrentScopeAsDynamic)(R, P, `revalidate: 0 fetch ${u} ${R.route}`);
                A && S === _ && (A.revalidate = _);
              }
              ...
              if (V && (F || (null == $ ? void 0 : $.serverComponentsHmrCache)))
                try {
                  n = await V.generateCacheKey(v, m ? u : f);
                } catch (e) {
                    ...
                    .then(async e => {
                      if (
                        ...
                        200 === e.status &&
                          V &&
                          n &&
                          (F || (null == $ ? void 0 : $.serverComponentsHmrCache)))
                      ) {
                        ...
                        if (P && 'prerender' === P.type) {
                          ...
                          return (
                            await V.set(
                              n,
                              { kind: l.CachedRouteKind.FETCH, data: a, revalidate: t },
                              { fetchCache: !0, fetchUrl: v, fetchIdx: X, tags: N }
                            ),
                            await q(),
                            new Response(r, {
                              headers: e.headers,
                        ...
                        }
                        {
                          ...
                          return (
                            r
                              ...
                              .catch(e => console.warn('Failed to set fetch cache', u, e))
                              .finally(q),
                            a
                          );
                        }
              ...
              if (n && V) {
                ...
                if (
                  ...
                  if (
                    ...
                    t ? await q() : (a = 'cache-control: no-cache (hard refresh)'),
              ...
              if (R.isStaticGeneration && f && 'object' == typeof f) {
                ...
                if ('no-store' === e)
                  ...
                  else (0, i.markCurrentScopeAsDynamic)(R, P, `no-store fetch ${u} ${R.route}`);
                let t = 'next' in f,
                  { next: r = {} } = f;
                if ('number' == typeof r.revalidate && A && r.revalidate < A.revalidate) {
                  if (0 === r.revalidate)
                    if (P && 'prerender' === P.type)
                      return (0, s.makeHangingPromise)(P.renderSignal, 'fetch()');
                    else
                      (0, i.markCurrentScopeAsDynamic)(R, P, `revalidate: 0 fetch ${u} ${R.route}`);
                  (R.forceStatic && 0 === r.revalidate) || (A.revalidate = r.revalidate);
                }
                t && delete f.next;
              }
              if (!n || !W) return K(!1, a);
    ...
    39938: (e, t, r) => {
      ...
      function i(e, t) {
        ...
        s &&
          ...
          ((c.pathname = (0, a.removePathPrefix)(c.pathname, s)), (c.basePath = s));
        let d = c.pathname;
      ...
      class i {
        ...
        async get(e, t, r) {
          ...
          let {
            ...
            u = await this.batcher.batch({ key: e, isOnDemandRevalidate: a }, async (u, l) => {
              var c;
              if (
                this.minimalMode &&
                (null == (c = this.previousCacheItem) ? void 0 : c.key) === u &&
                this.previousCacheItem.expiresAt > Date.now()
              )
                return this.previousCacheItem.entry;
              let d = (0, o.routeKindToIncrementalCacheKind)(r.routeKind),
                f = !1,
                p = null;
              try {
                if (
                ...
                let h = await (0, o.fromResponseCacheEntry)({ ...c, isMiss: !p });
                if (!h) return this.minimalMode && (this.previousCacheItem = void 0), null;
                return (
                  a || f || (l(h), (f = !0)),
                  h.cacheControl &&
                    (this.minimalMode
                      ? (this.previousCacheItem = { key: u, entry: h, expiresAt: Date.now() + 1e3 })
  ...
  `);
        ...
        if (e)
          for (let o of (r && (r = r.toLowerCase()), e)) {
            ...
            if (
              ...
              (null == (a = o.locales) ? void 0 : a.some(e => e.toLowerCase() === r))
            )
              return o;
          }
      }
    ...
    61120: (e, t, r) => {
      'use strict';
      e.exports = r(65239).vendored['react-rsc'].React;
    },
    65239: (e, t, r) => {
      'use strict';
      e.exports = r(10846);
      ...
      class c {
        constructor(e, t, r) {
          ...
          ('object' == typeof t && 'pathname' in t) || 'string' == typeof t
            ? ((n = t), (a = r || {}))
            : (a = r || t || {}),
            (this[l] = { url: u(e, n ?? a.base), options: a, basePath: '' }),
            this.analyze();
        }
        analyze() {
          var e, t, r, a, s;
          let u = (0, i.getNextPathnameInfo)(this[l].url.pathname, {
          ...
          let d =
            ...
            (null == (s = this[l].options.nextConfig) || null == (a = s.i18n)
              ? void 0
              : a.defaultLocale);
      ...
      class o {
        ...
        async pipeTo(e) {
          try {
            ...
            if ((0, a.isAbortError)(t)) return void (await e.abort(t));
            throw t;
          }
        }
    ...
    68388: (e, t) => {
      ...
      let o = new WeakMap();
      function i(e, t) {
        if (e.aborted) return Promise.reject(new a(t));
        {
          let r = new Promise((r, n) => {
            let i = n.bind(null, new a(t)),
              s = o.get(e);
            if (s) s.push(i);
            else {
              let t = [i];
          ...
          } = Object.fromEntries(n.map(([e, t]) => [e.toLowerCase().replace(/-/g, ''), t]));
        {
          var _,
            ...
            y = {
              ...
              path: d,
              ...(f && { sameSite: l.includes((_ = (_ = f).toLowerCase())) ? _ : void 0 }),
              ...(p && { secure: !0 }),
        ...
        (e.exports = ((e, o, i, s) => {
          if ((o && 'object' == typeof o) || 'function' == typeof o)
            for (let u of n(o))
              a.call(e, u) ||
                u === i ||
                t(e, u, { get: () => o[u], enumerable: !(s = r(o, u)) || s.enumerable });
          return e;
    ...
    76268: (e, t, r) => {
      ...
      class u extends Request {
        constructor(e, t = {}) {
          ...
          this[s] = { cookies: new i.RequestCookies(this.headers), nextUrl: o, url: o.toString() };
        }
        [Symbol.for('edge-runtime.inspect.custom')]() {
          return {
    ...
    77855: (e, t, r) => {
      ...
      function y({ ReactDOMServer: e, element: t, streamOptions: r }) {
        return (0, n.getTracer)().trace(a.AppRenderSpan.renderToReadableStream, async () =>
          ...
          async transform(n, a) {
            ...
            if (t) {
              ...
              if (-1 !== e) {
                ...
                t = !0;
              } else o && a.enqueue(d.encode(o)), a.enqueue(n), (t = !0);
            }
          },
          async flush(t) {
            if (r) {
      ...
      function S() {
        ...
        return new TransformStream({
          transform(t, r) {
            ...
            let n = (0, u.indexOfUint8Array)(t, s.ENCODED_TAGS.CLOSED.BODY_AND_HTML);
            if (n > -1) {
              if (((e = !0), t.length === s.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length)) return;
              let a = t.slice(0, n);
              if ((r.enqueue(a), t.length > s.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length + n)) {
      ...
      function O() {
        ...
        return new TransformStream({
          async transform(r, n) {
            !e && (0, u.indexOfUint8Array)(r, s.ENCODED_TAGS.OPENING.HTML) > -1 && (e = !0),
              !t && (0, u.indexOfUint8Array)(r, s.ENCODED_TAGS.OPENING.BODY) > -1 && (t = !0),
              n.enqueue(r);
          },
          flush(r) {
            let n = [];
...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags""
      ...
      async function P(e, { getServerInsertedHTML: t, getServerInsertedMetadata: r }) {
        return e
          .pipeThrough(m())
          .pipeThrough(
            new TransformStream({
              transform(e, t) {
                (0, u.isEquivalentUint8Arrays)(e, s.ENCODED_TAGS.CLOSED.BODY_AND_HTML) ||
                  (0, u.isEquivalentUint8Arrays)(e, s.ENCODED_TAGS.CLOSED.BODY) ||
                  (0, u.isEquivalentUint8Arrays)(e, s.ENCODED_TAGS.CLOSED.HTML) ||
                  ((e = (0, u.removeFromUint8Array)(e, s.ENCODED_TAGS.CLOSED.BODY)),
                  (e = (0, u.removeFromUint8Array)(e, s.ENCODED_TAGS.CLOSED.HTML)),
                  t.enqueue(e));
              },
            })
          )
      ...
      class b {
        ...
        trace(...e) {
          ...
          let [r, n, s] = e,
            ...
            f = c.spanName ?? r;
          if (
            (!a.NextVanillaSpanAllowlist.includes(r) && '1' !== process.env.NEXT_OTEL_VERBOSE) ||
            c.hideSpan
          )
            return l();
          ...
          return (
            ...
            i.with(p.setValue(_, v), () =>
              this.getTracerInstance().startActiveSpan(f, c, e => {
                ...
                m && g.set(v, new Map(Object.entries(c.attributes ?? {})));
                try {
        ...
        wrap(...e) {
          ...
          return a.NextVanillaSpanAllowlist.includes(r) || '1' === process.env.NEXT_OTEL_VERBOSE
            ? function () {
                let e = n;
      ...
      function $(e, t, r, n, a) {
        if (!V.test(t)) {
          ...
          if (U.test(t)) {
            ...
            return;
          } else if (n.syncDynamicErrorWithStack || a.syncDynamicErrorWithStack) {
        ...
        var t = {
            ...
            172: (e, t, r) => {
              ...
              (t.registerGlobal = function (e, t, r, n = !1) {
                var o;
                let i = (u[s] = null != (o = u[s]) ? o : { version: a.VERSION });
                if (!n && i[e]) {
                  let t = Error(
                ...
                (t.getGlobal = function (e) {
                  ...
                  if (n && (0, o.isCompatible)(n)) return null == (r = u[s]) ? void 0 : r[e];
                }),
            ...
            130: (e, t, r) => {
              ...
              function o(e) {
                ...
                return function (e) {
                  ...
                  if (0 === o.major)
                    return o.minor === s.minor && o.patch <= s.patch ? (t.add(e), !0) : i(e);
