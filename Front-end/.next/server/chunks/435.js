...
${t}`
    ...
    9221: (e, t, r) => {
                  ...
                  i = new Proxy(a, {
                    get(r, i, u) {
                      ...
                      switch (i) {
                        ...
                        default:
                          if ('string' == typeof i && !s.wellKnownProperties.has(i)) {
                            let r = (0, s.describeStringPropertyAccess)('searchParams', i),
                              n = O(e, r);
                    ...
                    has(r, a) {
                      if ('string' == typeof a) {
                        let r = (0, s.describeHasCheckingStringProperty)('searchParams', a),
                          n = O(e, r);
                        (0, o.abortAndThrowOnSynchronousRequestDataAccess)(e, r, n, t);
                      }
        ...
        let r = Promise.resolve({}),
          o = new Proxy(r, {
            get: (t, o, a) => (
              Object.hasOwn(r, o) ||
                'string' != typeof o ||
                ('then' !== o && s.wellKnownProperties.has(o)) ||
                (0, c.throwForSearchParamsAccessInUseCache)(e),
              n.ReflectAdapter.get(t, o, a)
            ),
            has: (t, r) => (
              'string' != typeof r ||
                ('then' !== r && s.wellKnownProperties.has(r)) ||
                (0, c.throwForSearchParamsAccessInUseCache)(e),
      ...
      let v = (0, l.createDedupedByCallsiteServerErrorLoggerDev)(O),
        E = (0, l.createDedupedByCallsiteServerErrorLoggerDev)(function (e, t, r) {
    ...
    10449: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored.contexts.HooksClientContext;
    },
    11264: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    11804: (e, t, r) => {
      ...
      function o({ openGraph: e }) {
        ...
        if ('type' in e) {
          ...
          switch (t) {
            case 'website':
              s = [(0, n.Meta)({ property: 'og:type', content: 'website' })];
              break;
            case 'article':
              s = [
            ...
            case 'video.episode':
              ...
              break;
            case 'video.tv_show':
              s = [(0, n.Meta)({ property: 'og:type', content: 'video.tv_show' })];
              break;
            case 'video.other':
              s = [(0, n.Meta)({ property: 'og:type', content: 'video.other' })];
              break;
            default:
              throw Object.defineProperty(
    ...
    12089: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/metadata/async-metadata.js'
      );
    },
    12776: (e, t, r) => {
      'use strict';
    ...
    12907: (e, t, r) => {
      'use strict';
      e.exports = r(65239).vendored['react-rsc'].ReactServerDOMWebpackServerEdge;
    },
    14077: (e, t) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    16042: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/client-segment.js'
      );
    },
    16444: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/client-page.js'
      );
    },
    17388: (e, t) => {
      'use strict';
    ...
    19357: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored['react-ssr'].ReactServerDOMWebpackClientEdge;
    },
    20884: (e, t, r) => {
      'use strict';
      var n = r(46033),
        ...
        function i(e, E) {
          ...
          if ('object' == typeof E) {
            ...
            if (void 0 !== (j = _.get(E)))
              ...
              -1 === e.indexOf(':') &&
                void 0 !== (j = _.get(this)) &&
                ((e = j + ':' + e), _.set(E, e), void 0 !== r && r.set(e, E));
            if (h(E)) return E;
                ...
                try {
                  ...
                  return (
                    ...
                    r.read().then(function e(l) {
                      if (l.done) a.append(t + u, 'C'), 0 == --s && n(a);
                      else
                        try {
                  ...
                  f.read(new Uint8Array(1024)).then(function e(r) {
                    r.done
                      ? ((r = l++),
                        ...
                        d.append(t + p, 'C'),
                        0 == --s && n(d))
                      : (y.push(r.value), f.read(new Uint8Array(1024)).then(e, o));
                  }, o),
                  '$r' + p.toString(16)
                );
              })(E);
                ...
                R.next().then(function e(r) {
                  if (r.done) {
                    ...
                    try {
                      ...
                      w.append(t + S, u), R.next().then(e, o);
                    } catch (e) {
                      o(e);
                    }
                }, o),
          ...
          if ('function' == typeof E) {
            if (void 0 !== (j = b.get(E)))
              return (
                (e = JSON.stringify({ id: j.id, bound: j.bound }, i)),
                null === c && (c = new FormData()),
                (j = l++),
                c.set(t + j, e),
                '$F' + j.toString(16)
              );
            if (void 0 !== r && -1 === e.indexOf(':') && void 0 !== (j = _.get(this)))
      ...
      function N(e, t) {
        if ('pending' !== e.status) e.reason.enqueueModel(t);
          ...
          var r = e.value,
            n = e.reason;
          (e.status = 'resolved_model'), (e.value = t), null !== r && (U(e), A(e, r, n));
        }
      }
      function F(e, t) {
        if ('pending' === e.status || 'blocked' === e.status) {
          var r = e.value,
            n = e.reason;
          (e.status = 'resolved_module'), (e.value = t), null !== r && (L(e), A(e, r, n));
        }
      }
      ...
      function U(e) {
        ...
        try {
          var n = JSON.parse(r, e._response._fromJSON),
            o = e.value;
          if ((null !== o && ((e.value = null), (e.reason = null), x(o, n)), null !== I)) {
      ...
      function H(e, t) {
        var r = e._chunks,
          n = r.get(t);
        return (
          n || ((n = e._closed ? new j('rejected', null, e._closedReason, e) : T(e)), r.set(t, n)),
          n
        );
      }
      function W(e, t, r, n, o, a) {
        ...
        if (I) {
          var u = I;
          u.deps++;
        } else u = I = { parent: null, chunk: null, value: null, deps: 1, errored: !1 };
        return (
          e.then(function e(l) {
            for (var s = 1; s < a.length; s++) {
              for (; l.$$typeof === d; )
                if ((l = l._payload) === u.chunk) l = u.value;
                else if ('fulfilled' === l.status) l = l.value;
                else {
                  a.splice(0, s - 1), l.then(e, i);
                  return;
                }
              l = l[a[s]];
            }
      ...
      function G(e, t, r, n) {
        ...
        if (a) t.bound && (a = Promise.all([a, t.bound]));
          ...
          if (!t.bound) return P((a = s(o)), t.id, t.bound, e._encodeFormAction), a;
          a = Promise.resolve(t.bound);
        }
        if (I) {
          var i = I;
          i.deps++;
        } else i = I = { parent: null, chunk: null, value: null, deps: 1, errored: !1 };
        return (
          a.then(
            function () {
              var a = s(o);
                ...
                if ('$' === a[0]) {
                  ...
                  switch (a[1]) {
                    case '$':
                      return a.slice(1);
                    case 'L':
                      return B((r = H(r, (n = parseInt(a.slice(2), 16)))));
                    case '@':
                ...
                if (t[0] === f) {
                  if (
                    ...
                    if (((I = (t = I).parent), t.errored))
                      e = B((e = new j('rejected', null, t.value, u)));
                    else if (0 < t.deps) {
                      var i = new j('blocked', null, null, u);
                      (t.value = e), (t.chunk = i), (e = B(i));
                    }
                  }
                } else e = t;
                return e;
        ...
        (i[y] = function () {
          ...
          return (
            ((t = {
              next: (t = function (t) {
                ...
                if (r === n.length) {
                  if (o) return new j('fulfilled', { done: !0, value: void 0 }, null, e);
                  n[r] = T(e);
                }
                return n[r++];
              }),
          ...
          et(e, t, r ? i[y]() : i, {
            enqueueValue: function (t) {
              if (a === n.length) n[a] = new j('fulfilled', { done: !1, value: t }, null, e);
              else {
                var r = n[a],
                  o = r.value,
                  i = r.reason;
            ...
            enqueueModel: function (t) {
              a === n.length ? (n[a] = D(e, t, !1)) : C(n[a], t, !1), a++;
            },
            close: function (t) {
              for (
                o = !0, a === n.length ? (n[a] = D(e, t, !0)) : C(n[a], t, !0), a++;
                a < n.length;
            ...
            error: function (t) {
              for (o = !0, a === n.length && (n[a] = T(e)); a < n.length; ) k(n[a++], t);
            },
          });
      }
      function ea() {
          ...
          .then(function t(a) {
            ...
            if (a.done) $(e, Error('Connection closed.'));
              ...
              var u = 0,
                s = e._rowState;
              a = e._rowID;
              for (var f = e._rowTag, d = e._rowLength, p = e._buffer, y = i.length; u < y; ) {
                var h = -1;
                switch (s) {
                  case 0:
                    58 === (h = i[u++]) ? (s = 1) : (a = (a << 4) | (96 < h ? h - 87 : h - 48));
                    continue;
                  case 1:
                    84 === (s = i[u]) ||
                    65 === s ||
                    ...
                    continue;
                  case 2:
                    44 === (h = i[u++]) ? (s = 4) : (d = (d << 4) | (96 < h ? h - 87 : h - 48));
                    continue;
                  case 3:
                    h = i.indexOf(10, u);
                    break;
                ...
                if (-1 < h)
                  (function (e, t, r, n, a) {
                    ...
                    for (var i = e._stringDecoder, u = '', s = 0; s < n.length; s++)
                      u += i.decode(n[s], o);
                      ...
                      case 73:
                        ...
                        if (
                          ...
                          if (h) {
                            var m = h;
                            m.status = 'blocked';
                          } else (m = new j('blocked', null, null, f)), y.set(d, m);
                          p.then(
                            function () {
                              return F(m, g);
                            },
                        ...
                        } else h ? F(h, g) : y.set(d, new j('resolved_module', g, null, f));
                        break;
                      case 72:
                        switch (
                          ((t = n[0]),
                  ...
                  })(e, a, f, p, (d = new Uint8Array(i.buffer, g, h - u))),
                    (u = h),
                    3 === s && u++,
                    (d = a = f = s = 0),
                    (p.length = 0);
                else {
                  (i = new Uint8Array(i.buffer, g, i.byteLength - u)),
                    p.push(i),
                    (d -= i.byteLength);
                  break;
                }
    ...
    21709: (e, t, r) => {
      ...
      let g = new o.LRUCache(1e4, e => e.length);
      function m(...e) {
        let t = e.join(' ');
        g.has(t) || (g.set(t, t), f(...e));
      }
    },
    22113: (e, t) => {
      'use strict';
    ...
    22142: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored.contexts.AppRouterContext;
    },
    22586: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    27924: (e, t, r) => {
      ...
      function a(e) {
        let { Component: t, slots: a, params: i, promise: u } = e;
        {
          ...
          let { createParamsFromClient: s } = r(60824);
          return (e = s(i, l)), (0, n.jsx)(t, { ...a, params: e });
        }
      }
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    28827: (e, t, r) => {
      ...
      let n = r(60687),
        o = r(43210),
        a = r(85429).ServerInsertMetadata;
      function i(e) {
        let { promise: t } = e,
    ...
    28938: (e, t, r) => {
      ...
      let n = r(37413),
        ...
        s = r(62713);
      function c(e) {
        let t = (0, s.getDigestForWellKnownError)(e);
        if (t) return t;
      }
      async function f(e, t, r, l, s, f) {
        let p = new Map();
        try {
        ...
        let y = new AbortController(),
          h = async () => {
            await (0, u.waitAtLeastOneReactRenderTask)(), y.abort();
          },
          g = [],
          { prelude: m } = await (0, a.unstable_prerender)(
            ...
            l,
            { signal: y.signal, onError: c }
          ),
          b = await (0, i.streamToBuffer)(m);
        for (let [e, t] of (p.set('/_tree', b), await Promise.all(g))) p.set(e, t);
        return p;
      }
      async function d({
        shouldAssumePartialData: e,
        ...
        let m = g[0][0],
          b = g[0][1],
          _ = g[0][2],
          v = (function e(t, r, n, o, a, i, s, c, f, d) {
            let y = null,
              h = r[1],
              g = null !== o ? o[2] : null;
            for (let r in h) {
              let o = h[r],
                u = o[0],
                p = null !== g ? g[r] : null,
                m = (0, l.encodeChildSegmentKey)(
                  f,
                  r,
                  Array.isArray(u) && null !== a
                    ? (function (e, t) {
                        let r = e[0];
                        if (!t.has(r)) return (0, l.encodeSegment)(e);
                        let n = (0, l.encodeSegment)(e),
                          o = n.lastIndexOf('$');
                        return n.substring(0, o + 1) + `[${r}]`;
                      })(u, a)
                    : (0, l.encodeSegment)(u)
                ),
                b = e(t, o, n, p, a, i, s, c, m, d);
              null === y && (y = {}), (y[r] = b);
            }
            return (
              null !== o &&
                d.push((0, u.waitAtLeastOneReactRenderTask)().then(() => p(t, n, o, f, s))),
              { segment: r[0], slots: y, isRootLayout: !0 === r[4] }
            );
          })(e, m, h, b, r, t, a, n, l.ROOT_SEGMENT_KEY, c),
          E = e || (await y(_, a));
        return f(), { buildId: h, tree: v, head: _, isHeadPartial: E, staleTime: s };
      }
      async function p(e, t, r, n, o) {
        let s = r[1],
          f = { buildId: t, rsc: s, loading: r[3], isPartial: e || (await y(s, o)) },
          d = new AbortController();
        (0, u.waitAtLeastOneReactRenderTask)().then(() => d.abort());
        let { prelude: p } = await (0, a.unstable_prerender)(f, o, {
            signal: d.signal,
            onError: c,
          }),
          h = await (0, i.streamToBuffer)(p);
        return n === l.ROOT_SEGMENT_KEY ? ['/_index', h] : [n, h];
      }
    ...
    29345: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/layout-router.js'
      );
    },
    30893: (e, t, r) => {
      'use strict';
    ...
    31307: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/render-from-template-context.js'
      );
    },
    33123: (e, t, r) => {
      'use strict';
    ...
    37413: (e, t, r) => {
      'use strict';
      e.exports = r(65239).vendored['react-rsc'].ReactJsxRuntime;
    },
    37697: (e, t) => {
      'use strict';
      function r() {
    ...
    38243: (e, t, r) => {
      ...
      function P(e) {
        let { segmentPath: t, children: r } = e,
          n = (0, u.useContext)(s.GlobalLayoutRouterContext);
        if (!n)
          throw Object.defineProperty(
      ...
      function R(e) {
        let { tree: t, segmentPath: r, cacheNode: n, url: o } = e,
          l = (0, u.useContext)(s.GlobalLayoutRouterContext);
        if (!l)
          throw Object.defineProperty(
            Error('invariant global layout router not mounted'),
            '__NEXT_ERROR_CODE',
        ...
        let { tree: d } = l,
          y = null !== n.prefetchRsc ? n.prefetchRsc : n.rsc,
          h = (0, u.useDeferredValue)(n.rsc, y),
          g = 'object' == typeof h && null !== h && 'function' == typeof h.then ? (0, u.use)(h) : h;
        if (!g) {
          let e = n.lazyData;
          if (null === e) {
      ...
      function S(e) {
        let {
          ...
          b = (0, u.useContext)(s.LayoutRouterContext);
        if (!b)
          throw Object.defineProperty(
        ...
        let M = _[0],
          T = _[1][t],
          x = T[0],
          A = null === E ? [t] : E.concat([M, t]),
          k = (0, m.createRouterCacheKey)(x),
          D = (0, m.createRouterCacheKey)(x, !0),
          C = j.get(k);
        if (void 0 === C) {
          let e = {
            lazyData: null,
          ...
          s.TemplateContext.Provider,
          {
            value: (0, a.jsx)(P, {
              ...
              children: (0, a.jsx)(d.ErrorBoundary, {
                ...
                children: (0, a.jsx)(w, {
                  loading: N,
                  children: (0, a.jsx)(g.HTTPAccessFallbackBoundary, {
                    notFound: f,
                    forbidden: p,
                    unauthorized: y,
                    children: (0, a.jsx)(h.RedirectBoundary, {
                      children: (0, a.jsx)(R, { url: O, tree: T, cacheNode: C, segmentPath: A }),
                    }),
                  }),
                }),
              }),
    ...
    39695: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored.contexts.ServerInsertedHtml;
    },
    39844: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      let n = r(12907).createClientModuleProxy;
    },
    40099: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      class s extends a.default.Component {
        ...
        render() {
          ...
          if (a) {
            let l = a === u.HTTPAccessErrorStatus.NOT_FOUND && e,
      ...
      function c(e) {
        let { notFound: t, forbidden: r, unauthorized: n, children: u } = e,
          ...
          f = (0, a.useContext)(l.MissingSlotContext);
        return t || r || n
          ? (0, o.jsx)(s, {
              pathname: c,
              notFound: t,
    ...
    42706: (e, t, r) => {
      ...
      async function v(e, t, r) {
        ...
        let o = e[r].map(async e => (0, s.interopDefault)(await e(t)));
      ...
      async function O({
        ...
        let i,
          u,
          s = !!(a && e[2][a]);
        if (a) (i = await (0, l.getComponentTypeModule)(e, 'layout')), (u = a);
        else {
      ...
      async function w(e, t, r, n, o, a, i, u, l) {
        let s,
          [c, f, { page: d }] = t,
          p = r && r.length ? [...r, c] : [c],
          h = u(c),
          m = n;
        h && null !== h.value && (m = { ...n, [h.param]: h.value });
        let b = (0, g.createServerParamsForMetadata)(m, l);
        for (let r in ((s = void 0 !== d ? { params: b, searchParams: o } : { params: b }),
        await O({
          tree: t,
          metadataItems: e,
          errorMetadataItem: i,
          errorConvention: a,
          props: s,
          route: p.filter(e => e !== y.PAGE_SEGMENT_KEY).join('/'),
        }),
        f)) {
          let t = f[r];
          await w(e, t, p, m, o, a, i, u, l);
        }
      ...
      async function j(e, t, r, n, o, a, i, u, l) {
        let s,
          [c, f, { page: d }] = t,
          p = r && r.length ? [...r, c] : [c],
          h = u(c),
        ...
        f)) {
          let t = f[r];
          await j(e, t, p, m, o, a, i, u, l);
        }
        return 0 === Object.keys(f).length && a && e.push(i.current), e;
      }
      let M = e => !!(null == e ? void 0 : e.absolute),
        T = e => M(null == e ? void 0 : e.title);
      function x(e, t) {
        e &&
      ...
      async function k(e, t) {
        ...
        for (let o = 0; o < e.length; o++) {
          ...
          if (
            o <= 1 &&
            (E = null == O || null == (g = O.icon) ? void 0 : g[0]) &&
            ...
            for (let r in e)
              switch (r) {
                ...
                case 'alternates':
                  ...
                  break;
                case 'openGraph':
                  t.openGraph = (0, a.resolveOpenGraph)(e.openGraph, d, o, n.openGraph);
                  break;
                case 'twitter':
...
Read more: https://nextjs.org/docs/app/api-reference/functions/generate-viewport`);
            ...
            !(function (e, t, r, n, o, i) {
              var u, l;
              if (!r) return;
              let { icon: s, apple: c, openGraph: f, twitter: d, manifest: p } = r;
              if (
                (s && (i.icon = s),
                c && (i.apple = c),
                d && !(null == e || null == (u = e.twitter) ? void 0 : u.hasOwnProperty('images')))
              ) {
              ...
              if (
                f &&
                !(null == e || null == (l = e.openGraph) ? void 0 : l.hasOwnProperty('images'))
              ) {
        ...
        if (
          ...
          for (let e of s.warnings) h.warn(e);
        return (function (e, t, r, n) {
          ...
          if (o) {
            let t = {},
              ...
              s = !!((null == i ? void 0 : i.hasOwnProperty('images')) && i.images);
            if (
              (!u &&
                (M(o.title) ? (t.title = o.title) : e.title && M(e.title) && (t.title = e.title)),
              ...
              e.twitter
                ? (e.twitter = Object.assign({}, e.twitter, {
                    ...
                    ...(!l && { description: null == o ? void 0 : o.description }),
                    ...(!s && { images: null == o ? void 0 : o.images }),
                  }))
                : (e.twitter = o);
            }
          }
      ...
      async function D(e) {
        ...
        for (; n < r.length; ) {
          ...
          })({ target: t, source: F(o) ? await o : o });
        }
        return t;
      }
      async function C(e, t, r, n, o, a) {
        return k(await R(e, t, r, n, o), a);
      }
      async function N(e, t, r, n, o) {
        return D(await S(e, t, r, n, o));
      }
      function F(e) {
    ...
    43210: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored['react-ssr'].React;
    },
    46033: (e, t, r) => {
      'use strict';
      e.exports = r(65239).vendored['react-rsc'].ReactDOM;
    },
    46453: (e, t) => {
      'use strict';
      function r(e) {
    ...
    46577: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/metadata/metadata-boundary.js'
      );
    },
    49026: (e, t, r) => {
      'use strict';
    ...
    49477: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/http-access-fallback/error-boundary.js'
      );
    },
    50148: (e, t) => {
      'use strict';
    ...
    51215: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored['react-ssr'].ReactDOM;
    },
    51846: (e, t) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
...
${t}`
    ...
    55211: (e, t, r) => {
      ...
      let n = '' + r(86358).HTTP_ERROR_FALLBACK_ERROR_CODE + ';404';
      function o() {
    ...
    59008: (e, t, r) => {
      ...
      let n = r(91563),
        ...
        l = r(59880),
        s = r(38637),
        { createFromReadableStream: c } = r(19357);
      function f(e) {
      ...
      async function y(e, t) {
        ...
        try {
          ...
          let t = a ? (a === i.PrefetchKind.TEMPORARY ? 'high' : 'low') : 'auto',
            r = await h(e, s, t, p.signal),
            o = f(r.url),
            y = r.redirected ? o : void 0,
          ...
          let O = _
              ...
              : r.body,
            P = await g(O);
          if ((0, l.getAppBuildId)() !== P.b) return d(r.url);
          return {
    ...
    59521: (e, t, r) => {
      ...
      function m({
        ...
        let m = (0, h.createServerSearchParamsForMetadata)(t, l);
        function _() {
          return O(e, m, a, l, u);
        }
        async function E() {
          try {
            ...
            if (!u && (0, f.isHTTPAccessFallbackError)(t))
              try {
                return await R(e, m, a, l);
              } catch {}
            return null;
          }
        }
        function P() {
          return b(e, m, a, r, l, u);
        }
        async function w() {
          let t,
            n = null;
          try {
            ...
            if (((n = o), !u && (0, f.isHTTPAccessFallbackError)(o)))
              try {
                return {
                  metadata: (t = await v(e, m, a, r, l)),
                  error: n,
                  digest: null == n ? void 0 : n.digest,
                };
              } catch (e) {
                if (((n = e), g && (0, y.isPostpone)(e))) throw e;
              }
            if (g && (0, y.isPostpone)(o)) throw o;
        ...
        return (
          ...
          (S.displayName = d.METADATA_BOUNDARY_NAME),
          {
            ...
            MetadataTree: function () {
              return (0, n.jsx)(s, { children: (0, n.jsx)(S, {}) });
            },
            getViewportReady: M,
            getMetadataReady: j,
            StreamingMetadataOutlet: function () {
              return g ? (0, n.jsx)(p.AsyncMetadataOutlet, { promise: w() }) : null;
            },
          }
        );
      }
      ...
      async function _(e, t, r, n, o, a) {
        return S(e, t, r, n, o, 'redirect' === a ? void 0 : a);
      }
      let v = (0, o.cache)(E);
      ...
      async function S(e, t, r, f, d, p) {
        var y;
        let h =
          ((y = await (0, s.resolveMetadata)(e, t, p, r, d, f)),
          (0, c.MetaFilter)([
            (0, a.BasicMeta)({ metadata: y }),
            (0, i.AlternatesMetadata)({ alternates: y.alternates }),
            (0, a.ItunesMeta)({ itunes: y.itunes }),
            (0, a.FacebookMeta)({ facebook: y.facebook }),
            (0, a.PinterestMeta)({ pinterest: y.pinterest }),
            (0, a.FormatDetectionMeta)({ formatDetection: y.formatDetection }),
            (0, a.VerificationMeta)({ verification: y.verification }),
            (0, a.AppleWebAppMeta)({ appleWebApp: y.appleWebApp }),
            (0, u.OpenGraphMetadata)({ openGraph: y.openGraph }),
            (0, u.TwitterMetadata)({ twitter: y.twitter }),
            (0, u.AppLinksMeta)({ appLinks: y.appLinks }),
            (0, l.IconsMetadata)({ icons: y.icons }),
          ]));
        return (0, n.jsx)(n.Fragment, {
          children: h.map((e, t) => (0, o.cloneElement)(e, { key: t })),
        });
      }
      async function j(e, t, r, i, u) {
        var l;
        let f =
          ((l = await (0, s.resolveViewport)(e, t, u, r, i)),
          (0, c.MetaFilter)([(0, a.ViewportMeta)({ viewport: l })]));
        return (0, n.jsx)(n.Fragment, {
    ...
    60687: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored['react-ssr'].ReactJsxRuntime;
    },
    60824: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      let m = (0, l.createDedupedByCallsiteServerErrorLoggerDev)(_),
        b = (0, l.createDedupedByCallsiteServerErrorLoggerDev)(function (e, t, r) {
          let n = e ? `Route "${e}" ` : 'This route ';
          return Object.defineProperty(
            Error(
    ...
    62713: (e, t, r) => {
      ...
      function p(e, t) {
        return r => {
          ...
          let u = d(r);
          if (u) return u;
          let l = (0, c.getProperError)(r);
          l.digest || (l.digest = (0, n.default)(l.message + l.stack || '').toString()),
            e && (0, o.formatServerError)(l);
          let s = (0, a.getTracer)().getActiveScopeSpan();
          return (
            s &&
              (s.recordException(l),
              s.setStatus({ code: a.SpanStatusCode.ERROR, message: l.message })),
            t(l),
            (0, f.createDigestWithErrorCode)(r, l.digest)
          );
        };
      }
      function y(e, t, r, u, l) {
        return s => {
          var p;
          if ('string' == typeof s) return (0, n.default)(s).toString();
          if ((0, i.isAbortError)(s)) return;
          let y = d(s);
          if (y) return y;
          let h = (0, c.getProperError)(s);
          if (
            (h.digest || (h.digest = (0, n.default)(h.message + (h.stack || '')).toString()),
            r.has(h.digest) || r.set(h.digest, h),
            e && (0, o.formatServerError)(h),
            !(
              t &&
              (null == h || null == (p = h.message)
                ? void 0
                : p.includes(
            ...
            e &&
              (e.recordException(h),
              e.setStatus({ code: a.SpanStatusCode.ERROR, message: h.message })),
              u || null == l || l(h);
          }
          return (0, f.createDigestWithErrorCode)(s, h.digest);
        };
      }
      function h(e, t, r, u, l, s) {
        return (p, y) => {
          var h;
          let g = !0;
          ...
          if (
            (b.digest
              ? r.has(b.digest) && ((p = r.get(b.digest)), (g = !1))
              : (b.digest = (0, n.default)(
                  b.message + ((null == y ? void 0 : y.componentStack) || b.stack || '')
                ).toString()),
            e && (0, o.formatServerError)(b),
            !(
              t &&
              (null == b || null == (h = b.message)
                ? void 0
                : h.includes(
                    'The specific message is omitted in production builds to avoid leaking sensitive details.'
                  ))
      ...
      function g(e) {
        return (
          !(0, i.isAbortError)(e) && !(0, u.isBailoutToCSRError)(e) && !(0, s.isNextRouterError)(e)
        );
      }
    },
    62763: (e, t, r) => {
    ...
    65773: (e, t, r) => {
      ...
      let n = r(43210),
        ...
        l = r(80178),
        s = r(39695),
        c = r(54717).useDynamicRouteParams;
      function f() {
    ...
    66483: (e, t, r) => {
      ...
      let c = {
        ...
        f = (e, t, r, i) => {
          ...
          return (
            !(function (e, o) {
              ...
              e.images = s(o.images, t, r.isStaticMetadataRouteFile);
            })(u, e),
        ...
        p = (e, t, r, o) => {
          ...
          for (let t of d) l[t] = e[t] || null;
          if (
            ((l.images = s(e.images, t, r.isStaticMetadataRouteFile)),
            (u =
              u ||
              ((null == (i = l.images) ? void 0 : i.length) ? 'summary_large_image' : 'summary')),
            (l.card = u),
            'card' in l)
          )
            switch (l.card) {
    ...
    68524: (e, t, r) => {
      'use strict';
      e.exports = r(94041).vendored.contexts.ServerInsertedMetadata;
    },
    68613: (e, t, r) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      let n = r(42292).unstable_rethrow;
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
        Object.assign(t.default, t),
    ...
    75317: (e, t) => {
      ...
      let { env: n, stdout: o } = (null == (r = globalThis) ? void 0 : r.process) ?? {},
        ...
        s = u('\x1b[1m', '\x1b[22m', '\x1b[22m\x1b[1m'),
    ...
    80407: (e, t, r) => {
      ...
      function s({ propertyPrefix: e, namePrefix: t, contents: r }) {
        return null == r
          ? null
          : i(
              r.map(r =>
    ...
    80414: (e, t, r) => {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        r(86358).HTTP_ERROR_FALLBACK_ERROR_CODE,
        ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
          (Object.defineProperty(t.default, '__esModule', { value: !0 }),
          Object.assign(t.default, t),
    ...
    86346: (e, t, r) => {
      ...
      function a(e) {
        let { Component: t, searchParams: a, params: i, promises: u } = e;
        {
          ...
          e = c(a, s);
          let { createParamsFromClient: f } = r(60824);
          return (u = f(i, s)), (0, n.jsx)(t, { params: u, searchParams: e });
        }
      }
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    88170: (e, t, r) => {
      let { createProxy: n } = r(39844);
      e.exports = n(
        '/Users/kxz/Desktop/Web-practice/Personal-Blog/Front-end/node_modules/next/dist/client/components/error-boundary.js'
      );
    },
    89330: (e, t) => {
      'use strict';
    ...
    93972: (e, t, r) => {
      'use strict';
      e.exports = r(65239).vendored['react-rsc'].ReactServerDOMWebpackStaticEdge;
    },
    94041: (e, t, r) => {
      'use strict';
      e.exports = r(10846);
        ...
        if (
          ...
          if (!e) {
            try {
              var i;
              let e = new URL(o);
              (n = null != t && e.origin !== t.origin), (i = e.pathname), (a = s.test(i));
            } catch {
              n = !0;
            }
            if (!a && !n && !r) return `${o}/`;
