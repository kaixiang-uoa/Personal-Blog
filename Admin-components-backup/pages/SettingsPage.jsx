...
export default function SettingsPage() {
  const { activeTab: globalActiveTab } = useAppContext()
  ...
  // 从全局context中同步activeTab和检查URL锚点
  useEffect(() => {
    // 只有当全局activeTab是 "profile" 时才同步，避免影响其他操作
    if (globalActiveTab === "profile") {
    ...
    const checkHash = () => {
      ...
      if (hash && ["general", "appearance", "notifications", "security", "profile"].includes(hash)) {
        setActiveTab(hash);
      }
    }
