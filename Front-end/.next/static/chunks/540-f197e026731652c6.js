  ...
  [540],
  {
          ...
          (0, a.jsx)(n.sG.label, {
            ...
            onMouseDown: r => {
              ...
              r.target.closest('button, input, select, textarea') ||
                (null == (o = e.onMouseDown) || o.call(e, r),
    ...
    9688: (e, r, o) => {
      ...
      let w = e => {
        ...
        S = e => e.endsWith('%') && $(e.slice(0, -1)),
        O = e => j.test(e),
        I = () => !0,
        _ = e => N.test(e) && !C.test(e),
        R = () => !1,
        W = e => P.test(e),
        A = e => E.test(e),
        D = e => !V(e) && !X(e),
      ...
      let ed = (function (e, ...r) {
        ...
        return function () {
          return a(k.apply(null, arguments));
        };
      })(() => {
        let e = x('color'),
          r = x('font'),
          ...
          N = () => [X, V, i],
          C = () => [M, 'full', 'auto', ...N()],
          P = () => [G, 'none', 'subgrid', X, V],
          E = () => ['auto', { span: ['full', G, X, V] }, G, X, V],
          _ = () => [G, 'auto', X, V],
          R = () => ['auto', 'min', 'max', 'fr', X, V],
          W = () => [
            'start',
            'end',
            'center',
        ...
        return {
          ...
          classGroups: {
            aspect: [{ aspect: ['auto', 'square', M, V, X, g] }],
            container: ['container'],
            columns: [{ columns: [$, V, X, s] }],
            ...
            z: [{ z: [G, 'auto', X, V] }],
            basis: [{ basis: [M, 'full', 'auto', s, ...N()] }],
            'flex-direction': [{ flex: ['row', 'row-reverse', 'col', 'col-reverse'] }],
            'flex-wrap': [{ flex: ['nowrap', 'wrap', 'wrap-reverse'] }],
            flex: [{ flex: [$, M, 'auto', 'initial', 'none', V] }],
            grow: [{ grow: ['', $, X, V] }],
            shrink: [{ shrink: ['', $, X, V] }],
            ...
            'line-clamp': [{ 'line-clamp': [$, 'none', X, q] }],
            leading: [{ leading: [a, ...N()] }],
            ...
            'text-decoration-thickness': [{ decoration: [$, 'from-font', 'auto', X, L] }],
            'text-decoration-color': [{ decoration: eo() }],
            'underline-offset': [{ 'underline-offset': [$, 'auto', X, V] }],
            ...
            'outline-offset': [{ 'outline-offset': [$, X, V] }],
            'outline-w': [{ outline: ['', $, Z, L] }],
            ...
            blur: [{ blur: ep() }],
            brightness: [{ brightness: [$, X, V] }],
            contrast: [{ contrast: [$, X, V] }],
            'drop-shadow': [{ 'drop-shadow': ['', 'none', u, Y, Q] }],
            'drop-shadow-color': [{ 'drop-shadow': eo() }],
            grayscale: [{ grayscale: ['', $, X, V] }],
            'hue-rotate': [{ 'hue-rotate': [$, X, V] }],
            invert: [{ invert: ['', $, X, V] }],
            saturate: [{ saturate: [$, X, V] }],
            sepia: [{ sepia: ['', $, X, V] }],
            'backdrop-filter': [{ 'backdrop-filter': ['', 'none', X, V] }],
            'backdrop-blur': [{ 'backdrop-blur': ep() }],
            'backdrop-brightness': [{ 'backdrop-brightness': [$, X, V] }],
            'backdrop-contrast': [{ 'backdrop-contrast': [$, X, V] }],
            'backdrop-grayscale': [{ 'backdrop-grayscale': ['', $, X, V] }],
            'backdrop-hue-rotate': [{ 'backdrop-hue-rotate': [$, X, V] }],
            'backdrop-invert': [{ 'backdrop-invert': ['', $, X, V] }],
            'backdrop-opacity': [{ 'backdrop-opacity': [$, X, V] }],
            'backdrop-saturate': [{ 'backdrop-saturate': [$, X, V] }],
            'backdrop-sepia': [{ 'backdrop-sepia': ['', $, X, V] }],
            ...
            duration: [{ duration: [$, 'initial', X, V] }],
            ease: [{ ease: ['linear', 'initial', h, X, V] }],
            delay: [{ delay: [$, X, V] }],
            animate: [{ animate: ['none', k, X, V] }],
